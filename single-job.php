...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) { ?>
    ...
    <b><strong>EmployerId:</strong></b> <?php echo $EmployerId=$row["EmployerId"];?> <hr>
    <b><strong>CompanyName:</strong></b>   <?php echo $row["CompanyName"];?><hr>
    <b><strong>JobTitle:</strong></b>   <?php echo $row["JobTitle"];?><hr>
    <b><strong>Vacancy:</strong></b>   <?php echo $row["Vacancy"];?><hr>
    <b><strong>MinQualification:</strong></b>    <?php echo $row["MinQualification"];?><hr>
    <b><strong>Salary:</strong></b>   <?php echo $row["Salary"];?><hr>
    <b><strong>Description:</strong></b>    <?php echo $row["Description"];?><hr>
    <b><strong>Posted on:</strong></b>    <?php echo date("d-m-Y", strtotime($row["created_at"]));?>
...
<a href="registration.php" class="btn btn-primary"><strong>Apply For Job</strong></a>
<br><br><br>
</div>
